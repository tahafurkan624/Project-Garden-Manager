...
namespace PathCreation {
    ...
    public class VertexPath {
        ...
        public Quaternion GetRotationAtDistanceRev (float dst, EndOfPathInstruction endOfPathInstruction = EndOfPathInstruction.Loop) {
            float t = dst / length;
            var rot = GetRotation(t, endOfPathInstruction);
